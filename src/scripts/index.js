...
const profileEditForm = document.querySelector("#modal-form"); // From your HTML
const profileAddEditButton = document.querySelector("#profile-add-button");
...
// Initialize section and form validation
const cardSection = new Section(
  {
    items: initialCards,
    renderer: (cardData) => {
...
profileEditForm.addEventListener("submit", handleProfileEditSubmit); // Profile edit form submission
